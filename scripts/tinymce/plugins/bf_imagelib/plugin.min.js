  ...
  function changeImage() {
    ...
    buildfire.imageLib.showDialog(options, (err, results) => {
      ...
      if (imageProperties.resize) {
        widgetImageExpression = '${context.sdk.imageLib.resizeImage(\'' + imageUrl + '\', { size: \'' + imageProperties.responsive + '\', aspect: \'1:1\' })}';
      } else {
        widgetImageExpression = '${context.sdk.imageLib.cropImage(\'' + imageUrl + '\', { size: \'' + imageProperties.responsive + '\', aspect: \'' + imageProperties.crop + '\'' +  '})}';
      }
